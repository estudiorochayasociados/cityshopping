                                    ...
                                    <div class="dropdown messaging--dropdown">
                                        ...
                                        <div class="messages">
                                            ...
                                            <a href="message.html" class="message recent">
                                                <div class="message__actions_avatar">
                                                    <div class="avatar">
                                                        <img src="<?=URL?>/assets/images/notification_head5.png" alt="">
                                                    </div>
                                                </div>
                                                <!-- end /.actions -->
                                            ...
                                            <a href="message.html" class="message">
                                                <div class="message__actions_avatar">
                                                    <div class="avatar">
                                                        <img src="<?=URL?>/assets/images/notification_head6.png" alt="">
                                                    </div>
                                                </div>
                                                <!-- end /.actions -->
                                    ...
                                    <div class="dropdown dropdown--cart">
                                        <div class="cart_area">
                                            <div class="cart_product">
                                                <div class="product__info">
                                                    ...
                                                    <div class="info">
                                                        ...
                                                        <div class="cat">
                                                            <a href="#">
                                                                <img src="<?=URL?>/assets/images/catword.png" alt="">Wordpress</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="cart_product">
                                                <div class="product__info">
                                                    <div class="thumbn">
                                                        <img src="<?=URL?>/assets/images/capro2.jpg" alt="cart product thumbnail">
                                                    </div>
