...
$pedidosArraySinAgrupar = $pedido->list($filterPedidosSinAgrupar, "id ASC", "");
?>
<section>
                            ...
                            <div class="card">
                                <a data-toggle="collapse" href="#collapse<?= $value["cod"] ?>" aria-expanded="false" aria-controls="collapse<?= $value["cod"] ?>" class="collapsed color_a">
                                    <div class="card-header bg-info" role="tab" id="heading">
                                        ...
                                        <?php if ($value["estado"] == 0) : ?>
                                            <span class="pr-10 pl-5 fs-13 text-uppercase btn-danger pull-right">Estado: Carrito no cerrado</span>
                                        <?php elseif ($value["estado"] == 1) : ?>
                                            <span class="pr-10 pl-5 fs-13 text-uppercase btn-warning pull-right">Estado: Pago pendiente</span>
                                        <?php elseif ($value["estado"] == 2) : ?>
                                            <span class="pr-10 pl-5 fs-13 text-uppercase btn-success pull-right">Estado: Pago aprobado</span>
                                        <?php elseif ($value["estado"] == 3) : ?>
                                            <span class="pr-10 pl-5 fs-13 text-uppercase btn-primary pull-right">Estado: Pago enviado</span>
                                        <?php elseif ($value["estado"] == 4) : ?>
                                            <span class="pr-10 pl-5 fs-13 text-uppercase btn-danger pull-right">Estado: Pago rechazado</span>
                                        <?php endif; ?>
                                    </div>
                                </a>
                                <div id="collapse<?= $value["cod"] ?>" class="collapse" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false" style="height: 0px;">
                                    <div class="card-body">
                                        ...
                                        <a href="<?= CANONICAL ?>&estado=1&cod=<?= $value['cod'] ?>" class="pl-10 pr-10 text-uppercase bold btn-warning">Pendiente</a>
                                        <a href="<?= CANONICAL ?>&estado=2&cod=<?= $value['cod'] ?>" class="pl-10 pr-10 text-uppercase bold btn-success">Aprobado</a>
                                        <a href="<?= CANONICAL ?>&estado=3&cod=<?= $value['cod'] ?>" class="pl-10 pr-10 text-uppercase bold btn-info">Enviado</a>
                                        <a href="<?= CANONICAL ?>&estado=4&cod=<?= $value['cod'] ?>" class="pl-10 pr-10 text-uppercase bold btn-danger">Rechazado</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
